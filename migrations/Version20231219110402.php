 ...
 */
final class Version20231219110402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, created_by_id, modified_by_id, ref, name, description, tax_rate, price_no_tax, price_with_tax, weight, height, width, depth, stock, active, created_at, modified_at FROM product');
        ...
        , CONSTRAINT FK_D34A04ADB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD99049ECE FOREIGN KEY (modified_by_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04AD32119A01 FOREIGN KEY (id_company_id) REFERENCES company (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, created_by_id, modified_by_id, ref, name, description, tax_rate, price_no_tax, price_with_tax, weight, height, width, depth, stock, active, created_at, modified_at) SELECT id, created_by_id, modified_by_id, ref, name, description, tax_rate, price_no_tax, price_with_tax, weight, height, width, depth, stock, active, created_at, modified_at FROM __temp__product');
